...
public static class UiLanguage {
    ...
    internal static string? getEmbeddedString(string key, string cultureName) {
        string[] resourceNames = cultureName.Length == 0
            ? ["PasskeyPick.Resources.LocalizedStrings"]
            : [$"PasskeyPick.Resources.LocalizedStrings.{cultureName}", "PasskeyPick.Resources.LocalizedStrings"];
